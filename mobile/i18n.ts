  ...
  en: {
    translation: {
      ...
      "parent": {
        ...
        "searchDesc": "Enter the student full name and their portal access code to view academic records.",
        "loginDesc": "Enter the student full name and the 6-digit portal access code.",
      ...
      "teacher": {
        "portalLogin": "Teacher Login",
        "loginDesc": "Enter your full name and the 6-digit access code provided by the school admin.",
  ...
  am: {
    translation: {
      ...
      "parent": {
        ...
        "searchDesc": "የተማሪውን ሙሉ ስም እና የመግቢያ ኮድ በማስገባት የትምህርት መረጃውን መመልከት ይችላሉ።",
        "loginDesc": "የተማሪውን ሙሉ ስም እና ባለ 6 አሃዝ የመግቢያ ኮድ ያስገቡ።",
        ...
        "accessCodePlaceholder": "ባለ 6 አሃዝ ኮድ",
      ...
      "teacher": {
        ...
        "loginDesc": "ሙሉ ስምዎን እና በቤት አስተዳዳሪው የተሰጠዎትን ባለ 6 አሃዝ የመግቢያ ኮድ ያስገቡ።",
        "teacherName": "የመምህር ስም",
        "fullName": "የመምህር ሙሉ ስም",
        "accessCode": "የመግቢያ ኮድ",
        "accessCodePlaceholder": "ባለ 6 አሃዝ ኮድ",
        "students": "ተማሪዎች",
        "attendance": "ክትትል",
